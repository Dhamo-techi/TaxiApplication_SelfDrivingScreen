...
//  TaxiApplication
//
//  Created by MAC PRO on 18/06/24.
//
...
class CarTypeCell: UICollectionViewCell {
    ...
    func setupViews() {
        ...
        viewContent.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-10-[imgview(30)]-5-[lblTypeName]-10-|", options: [], metrics: nil, views: layoutDict))
